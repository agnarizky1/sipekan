<div class="container-fluid py-4">
    <div class="row">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <form action="<?= base_url('Pesanan/add') ?>" method="post">
                <div class="card-body">

                    <div class="form-group">
                        <div class="mb-3">
                            <label>Nama Customer</label>
                            <input name="customer" id="customer" placeholder="Nama Lengkap" class="form-control mx-1">
                        </div>
                    </div>

                    <div class="from-group">
                        <label for="no_hp">Nomor HP Customer</label>
                        <input name="no_hp" id="no_hp" placeholder="Nomor Hp" class="form-control mx-1">
                    </div>

                    <div class="form-group">
                        <label for="tanggal">Tanggal Keberangkatan</label>
                        <input type="date" name="tanggal" id="tanggal" placeholder="Detail Pemilik Provider" class="form-control mx-1">
                    </div>
